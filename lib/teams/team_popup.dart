...
class _CreateTeamPopupState extends State<CreateTeamPopup> {
  ...
  void _saveTeam() {
    debugPrint('Saved: $_ageGroup, $_country, $_timezone');
    if (!mounted) return;
    Navigator.of(context).pop(); // Simulate save and close popup
    ScaffoldMessenger.of(
      context,
    ).showSnackBar(const SnackBar(content: Text('Team created (local only)')));
  }
