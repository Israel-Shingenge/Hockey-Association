...
//       'volunteer_assignment': _selectedVolunteerAssignment,

//       'duration': _selectedDuration,

//       'home_away': _selectedHomeAway,

//       'uniform': _selectedUniform,

//       'not_for_standings': _notForStandings,

//       'notes': _notesController.text,

//       'notify_team': _notifyTeam,
...
//       await games.add(gameData);

//       ScaffoldMessenger.of(context).showSnackBar(SnackBar(

//         content: Text('Game Event Saved!'),
...
//             onPressed: _saveGameData, // Save game data to Firestore
...
//             // Add other fields for "Repeats", "Location", "Volunteer Assignments", etc.

//             // Similar to the structure above, with `_selectLocation`, `_selectVolunteerAssignment`, etc.



//             // For simplicity, just using placeholder code here for other fields
...
//                 // Show a dialog to select repeat frequency
